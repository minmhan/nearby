(function(){
    angular.module('nearme').controller('locNewModalCtrl', locNewModalCtrl);

    locNewModalCtrl.$inject = ['$uibModalInstance', 'nearmeData', 'locationData'];
    function locNewModalCtrl($uibModalInstance, nearmeData, locationData){
        var vm = this;
