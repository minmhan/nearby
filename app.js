...
var appClientFiles = [
  ...
  'app_client/locationNewModal/locNewModal.controller.js',
...
fs.writeFile('public/angular/nearme.min.js', uglified.code, function(err){
  if(err) {console.log(err); }
  else { console.log('Script generated and saved: nearme.min.js'); }
})
